...
| `test_*.py` | **86/86 全绿**（test_color + test_engine + 3mf + core + gui_guard + gui_web + reverse），直接 `python test_xxx.py`（无 pytest） |
...
- 调研文档：ONRhdXu56oLxbyx0kXAcFJ7qnne（迭代 41–50e 已同步）
